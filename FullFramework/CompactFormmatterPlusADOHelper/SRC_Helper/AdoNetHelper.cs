...
namespace DotNetRemoting
{
	...
	{
        static Type _GenericSerializerType;
		...
		public static byte[] SerializeTypedDataTable(DataTable dataTable)
		{
            ...
            Type[] types = new Type[] { };
            if (dataTable.GetType().GetConstructor(types) == null) throw new ArgumentException("Does not have a public, empty constructor", "dataTable");
            //if (dataTable.GetType().GetConstructor(Type.EmptyTypes) == null) throw new ArgumentException("Does not have a public, empty constructor", "dataTable");// orig
		...
		public static DataTable DeserializeTypedDataTable(Type dataTableType, byte[] serializedData)
		{
			...
			if (serializedData == null) throw new ArgumentNullException("serializedData");
            Type[] types = new Type[] { };
            if (dataTableType.GetConstructor(types) == null) throw new ArgumentException("Does not have a public, empty constructor", "dataTable");
            //if (dataTableType.GetConstructor(Type.EmptyTypes) == null) throw new ArgumentException("Does not have a public, empty constructor", "dataTable");// orig
